            ...
            <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0}>
                <div className="jenisKomunitas flex flex-col md:flex-col lg:flex-row justify-center gap-8 mt-[3rem] px-4 lg:px-0">
                    <div className="OR p-7 rounded-xl bg-[#003399] text-white text-center lg:text-left">
                        ...
                        <Link to='/KomunitasOlahraga' className='block lg:inline-block font-bold'>Lihat Selengkapnya</Link>
                    </div>
                    <div className="OR p-7 rounded-xl bg-[#003399] text-white text-center lg:text-left">
                        ...
                        <Link to='/KomunitasTeknologi' className='block lg:inline-block font-bold'>Lihat Selengkapnya</Link>
                    </div>
                </div>
            </FadeContent>
