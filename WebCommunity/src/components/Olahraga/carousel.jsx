    ...
    return(
        <div className='flex flex-wrap justify-center md:justify-evenly items-center bg-[#1A57A7] p-6 font-poppins gap-6'>
            <div className='flex justify-center items-center gap-4'>
                <img src={futsal} alt="" className='h-[4vh] w-[8vw] lg:h-[6vh] lg:w-[3vw] md:w-[3vw] md:h-[2vh] object-cover rounded-md'/>
                <p className='text-white font-semibold'>Blue Ice</p>
            </div>
            <div className='flex justify-center items-center gap-4'>
                <img src={volley} alt="" className='h-[vh] w-[8vw] lg:h-[6vh] lg:w-[3vw] md:w-[3vw] md:h-[2vh] object-cover rounded-md'/>
                <p className='text-white font-semibold'>Blue Knight</p>
            </div>
            <div className='flex justify-center items-center gap-4'>
                <img src={shuttle} alt="" className='h-[4vh] w-[8vw] lg:h-[6vh] lg:w-[3vw] md:w-[3vw] md:h-[2vh] object-cover rounded-md'/>
                <p className='text-white font-semibold'>Shuttle Blue</p>
            </div>
            <div className='flex justify-center items-center gap-4'>
                <img src={iball} alt="" className='h-[4vh] w-[8vw] lg:h-[6vh] lg:w-[3vw] md:w-[3vw] md:h-[2vh] object-cover rounded-md'/>
                <p className='text-white font-semibold'>I-Ball</p>
            </div>
            <div className='flex justify-center items-center gap-4'>
                <img src={isport} alt="" className='h-[4vh] w-[8vw] lg:h-[6vh] lg:w-[3vw] md:w-[3vw] md:h-[2vh] object-cover rounded-md'/>
