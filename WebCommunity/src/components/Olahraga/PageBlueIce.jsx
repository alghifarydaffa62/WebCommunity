            ...
            <div>
                ...
                <AnimatedContent
                    ...
                    <div className="flex justify-center mt-8 md:mt-10">
                        <Link to="https://chat.whatsapp.com/CIbjP0ph9l533bneciGmUg" target='_blank' className="py-3 px-6 bg-emerald-500 rounded-full text-white font-semibold shadow-md hover:bg-emerald-600 transition">
