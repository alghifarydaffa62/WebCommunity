        ...
        <div>
            ...
            <div className='h-screen flex flex-col justify-center items-center text-center px-4 md:px-8'>
                <AnimatedContent
                    ...
                    >
                    <div>
                        <h1 className='text-4xl md:text-6xl font-poppins text-[#174B86] font-bold leading-tight md:leading-18'>
                ...
                <AnimatedContent
                    ...
                    <div>
                        ...
                        <button onClick={handleScroll} className='mt-4 py-3 px-5 bg-[#1A57A7] rounded-full font-poppins text-white font-semibold text-sm md:text-base transition duration-300 ease-in-out hover:translate-y-[-4px] hover:shadow-lg'>
                            Jelajahi Komunitas
                        </button>
                    </div>
                </AnimatedContent>
